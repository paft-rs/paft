...
```toml
[dependencies]
paft-market = { version = "0.7.0", default-features = false }
```
...
```toml
[dependencies]
paft-market = { version = "0.7.0", default-features = false, features = ["bigdecimal"] }
```
...
```toml
[dependencies]
paft-market = { version = "0.7.0", default-features = false, features = ["dataframe"] }
```
