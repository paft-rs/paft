...
```toml
[dependencies]
paft-fundamentals = { version = "0.7.0", default-features = false }
```
...
```toml
[dependencies]
paft-fundamentals = { version = "0.7.0", default-features = false, features = ["bigdecimal"] }
```
...
```toml
[dependencies]
paft-fundamentals = { version = "0.7.0", default-features = false, features = ["dataframe"] }
```
