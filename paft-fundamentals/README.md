...
```toml
[dependencies]
paft-fundamentals = { version = "0.5.2", default-features = false }
```
...
```toml
[dependencies]
paft-fundamentals = { version = "0.5.2", default-features = false, features = ["bigdecimal"] }
```
...
```toml
[dependencies]
paft-fundamentals = { version = "0.5.2", default-features = false, features = ["dataframe"] }
```
