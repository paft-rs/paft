...
paft = { version = "0.7.0", features = ["dataframe"] }

# Or, opt into aggregates snapshot models as well
paft = { version = "0.7.0", features = ["aggregates"] }

# Or, enable the full bundle of features
paft = { version = "0.7.0", features = ["full"] }

# Or, customize your installation
paft = { version = "0.7.0", default-features = false, features = ["fundamentals", "dataframe"] }

# Switch the money backend to BigDecimal (default is rust_decimal)
paft = { version = "0.7.0", features = ["bigdecimal"] }
```
...
```toml
[dependencies]
paft = { version = "0.7.0", features = ["money-formatting"] }
```
...
```toml
[dependencies]
paft = { version = "0.7.0", features = ["panicking-money-ops"] }
```
