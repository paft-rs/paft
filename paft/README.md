...
paft = { version = "0.5.1", features = ["dataframe"] }

# Or, opt into aggregates/reporting models as well
paft = { version = "0.5.1", features = ["aggregates"] }

# Or, enable the full bundle of features
paft = { version = "0.5.1", features = ["full"] }

# Or, customize your installation
paft = { version = "0.5.1", default-features = false, features = ["fundamentals", "dataframe"] }
...
```toml
[dependencies]
paft = { version = "0.5.1", features = ["money-formatting"] }
```
...
```toml
[dependencies]
paft = { version = "0.5.1", features = ["panicking-money-ops"] }
```
