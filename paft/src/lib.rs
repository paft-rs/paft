...
pub mod domain {
    pub use paft_domain::{
        AssetKind, Canonical, CanonicalError, DomainError, Exchange, Figi, Horizon, Instrument,
        Isin, MarketState, OtherAssetKind, OtherExchange, OtherHorizon, OtherPeriod, Period,
        PeriodDate, PeriodYear, QuarterOfYear, StringCode, Symbol, canonicalize,
    };
    #[cfg(feature = "dataframe")]
