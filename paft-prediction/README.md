...
```toml
[dependencies]
paft = { version = "0.10.0", features = ["prediction"] }
```
...
```toml
[dependencies]
paft-prediction = { version = "0.10.0", default-features = false }
```
...
```toml
[dependencies]
paft-prediction = { version = "0.10.0", default-features = false, features = ["dataframe"] }
